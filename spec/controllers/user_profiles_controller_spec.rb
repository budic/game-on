...
describe UserProfilesController do
  ...
  let(:valid_attributes) { { "nickname" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_profile as @user_profile" do
        ...
        post :create, {:user_profile => { "nickname" => "invalid value" }}, valid_session
        assigns(:user_profile).should be_a_new(UserProfile)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_profile" do
        ...
        UserProfile.any_instance.should_receive(:update).with({ "nickname" => "MyString" })
        put :update, {:id => user_profile.to_param, :user_profile => { "nickname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the user_profile as @user_profile" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserProfile.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_profile.to_param, :user_profile => { "nickname" => "invalid value" }}, valid_session
        assigns(:user_profile).should eq(user_profile)
      end
